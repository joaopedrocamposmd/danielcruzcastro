...
const surgeonData = {
  name: "Dr. Daniel Cruz Castro",
  heroTag: "Especialista em Ortopedia",
  heroTitle: "Cirurgião de Pé e tornozelo",
  heroSubtitle: "Foot & Ankle Surgeon",
  heroDescription: "Dedicado à patologia do Pé e toprnozelo. O meu foco é proporcionar os tratamentos mais avançados, apoiados em dados e precisão clínica, para melhorar a sua qualidade de vida.",
  ...
  experiences: [
    {
      role: "Cirurgia do Pé e Tornozelo",
      company: "Lusíadas Saúde - Maia",
      period: "Set 2025 - Presente",
      location: "Maia",
    },
    {
      role: "Unidade do Pé e Tornozelo",
    ...
    {
      role: "Cirurgia do Pé e Tornozelo",
      company: "Hospital Privado da Boa Nova / Hospital de Dia da Maia / Hospital Privado de Gaia",
      period: "jan 2018 - Ago 2025",
      location: "Matosinhos, Gaia e Maia",
    },
    {
      role: "IFE Ortopedia e Traumatologia",
      company: "Hospital Pedro Hispano - ULSM",
      period: "Jan 2014 - Mar 2020",
      location: "Matosinhos",
    },
    {
      role: "Fellowship em Patologia do pé e tornozelo / Artroplastia do tornozelo",
      company: "Foot and Ankle Institute, Bruxelas",
      period: "Out 2018 - Dez 2018",
      location: "Bruxelas, Bélgica",
      description: "Desenvolvimento dos conhecimentos e técnicas cirúrgicas na área do diagnóstico e tratamento de lesões do pé e tornozelo com o Dr. Thibaut Leemrijse e Dr. Devos Bevernage no FOOT AND ANKLE INSTITUTE, com grande foco no tratamento do hallux valgus e protese do tornozelo."
    },
    {
      role: "Fellowship em patologia desportiva e instabilidade crónica do tornozelo",
      company: "Clinic du Sport",
      period: "Mai 2019 - jun 2019",
      location: "Bordeux-Merignac, França",
      description: "Desenvolvimento dos conhecimentos e técnicas cirúrgicas na área do diagnóstico e tratamento de lesões desportivas do pé e tornozelo, com foco na instabilidade crónica (entorse de repetição) com o Prof. Stéphane Guillo na Clinique du Sport."
    },
    {
      role: "Fellowship em Patologia do pé e tornozelo",
      company: "MEIN FUSSZENTRUM,",
      period: "Abr 2019",
      location: "Basel, Suiça",
      description: "Desenvolvimento dos conhecimentos e técnicas cirúrgicas na área do diagnóstico e tratamento de lesões do tornozelo e retropé com o Prof. Markus Knupp na MEIN FUSSZENTRUM,."
    }
  ],
  education: [
    {
    ...
    },
    {
      ...
      school: "Faculdade de Medicina da Universidade de Coimbra",
      period: "Set 2006 – Jul 2012",
    }
  ]
};
